          ...
          <div class="col-md-9 col-md-push-3">
            ...
            <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
              ...
              <div class="form-group">
                <label for="">Judul Post</label><input type="text" class="form-control" id="" name="judul">
                <label for="">Kategori</label><input type="text" class="form-control" id="" name="kategori">
                <label for="">Isi</label><input type="text" class="form-control" id="" name="judul">
              </div>
