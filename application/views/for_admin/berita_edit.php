        ...
        <div class="row">
          ...
          <div class="col-md-9 col-md-push-3">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <form action="<?=site_url('admin/berita_DoEdit/').$key->id_berita;?>" method="POST" role="form" enctype="multipart/form-data">
                <legend>Form Edit</legend>
                  ...
                  <div class="form-group">
                      ...
                      <textarea name="content" id="input" class="form-control" rows="3" required="required"><?=$key->content;?>
                      </textarea>
                  </div>
