        ...
        <div class="row">
          ...
          <div class="col-md-9 col-md-push-3">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <a href="<?=site_url('admin/pengumuman_add');?>"><span class="glyphicon glyphicon-plus"></span></a>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td><?=$key->content;?></td>
                          <td>
                              <a href="<?=site_url('admin/pengumuman_edit/').$key->id_pengumuman;?>"><span class="glyphicon glyphicon-edit"></span></a>
                              <a href="<?=site_url('admin/pengumuman_delete/').$key->id_pengumuman;?>"><span class="glyphicon glyphicon-trash"></span></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
