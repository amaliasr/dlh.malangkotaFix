        ...
        <div class="row">
          ...
          <div class="col-md-9 col-md-push-3">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <a href="<?=site_url('admin/dashuk_add');?>"><span class="glyphicon glyphicon-plus"></span></a>
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                          <td><?=$i++;?></td>
                          <td><?=$key->judul;?></td>
                          <td><?=$key->file_dashuk;?></td>
                          <td>
                              <a href="<?=site_url('admin/dashuk_edit/').$key->id_dashuk;?>"><span class="glyphicon glyphicon-edit"></span></a>
                              <a href="<?=site_url('admin/dashuk_delete/').$key->id_dashuk;?>"><span class="glyphicon glyphicon-trash"></span></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
