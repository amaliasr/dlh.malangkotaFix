        ...
        <div class="row">
          ...
          <div class="col-md-9 col-md-push-3">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                ...
                <form action="<?=site_url('admin/dokumen_DoEdit/').$key->id_dok_drop;?>" method="POST" role="form" enctype="multipart/form-data">
                <legend>Form Edit</legend>

                  <input type="hidden" name="file_lama" value="<?=$key->file_dokumen;?>">    
                  
                  <div class="form-group">
                      <label for="">Nama Dokumen</label>
                      <input type="text" name="nama_dropdown" class="form-control" id="" value="<?=$key->nama_dropdown?>">
                  </div>
