        ...
        <div class="row">
          ...
          <div class="col-md-9 col-md-push-3">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
              <form action="<?=site_url('admin/galery_DoAdd');?>" method="POST" role="form" enctype="multipart/form-data">
                <legend>Form Tambah</legend>
                        
                  <div class="form-group">
                      <label for="">Upload Gambar</label>
                      <input type="file" name="gambar" class="form-control" id="" placeholder="Input field">
                      <p class="help-block">Pilih foto dengan ukuran maksimal 1 MB<br>Ukuran gambar 1366 x 768</p>
                  </div>      
