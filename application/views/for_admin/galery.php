        ...
        <div class="row">
          ...
          <div class="col-md-9 col-md-push-3">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <a href="<?=site_url('admin/galery_add');?>"><span class="glyphicon glyphicon-plus"></span></a>
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                              <a href="<?=site_url('admin/galery_delete/').$key->id_gambar;?>"><span class="glyphicon glyphicon-trash"></span></a>
                          </td>
                        </tr>
                        <?php } ?>
                      </tbody>
